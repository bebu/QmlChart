...
module.export = function () { 'use strict';
    ...
    function duration_humanize__relativeTime (posNegDuration, withoutSuffix, locale) {
        ...
        var seconds  = round(duration.asFunc('s'));
        var minutes  = round(duration.asFunc('m'));
        var hours    = round(duration.asFunc('h'));
        var days     = round(duration.asFunc('d'));
        var months   = round(duration.asFunc('M'));
        var years    = round(duration.asFunc('y'));
    ...
    duration_prototype__proto.asFunc         = asFunc;
